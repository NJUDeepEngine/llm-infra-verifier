...
_DISPATCH_TABLE: List[Tuple[type, str]] = [
    ...
    ((SiLU, GELU, ReLU, Dropout), "_exec_per_device"),
    ((LayerNorm, RMSNorm, Softmax), "_exec_per_device"),
    (FlashAttention, "_exec_per_device"),
    (Embedding, "_exec_per_device"),
    (CrossEntropyLoss, "_exec_per_device"),
...
_SLICE_RULES: Dict[type, SliceRule] = {
    ...
    Embedding: SliceRule.NONE,
    CrossEntropyLoss: SliceRule.NONE,
}
